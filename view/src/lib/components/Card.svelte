...
<div
	{...restProps}
	class="{card_classes} relative h-48 w-32 shrink-0 transform cursor-pointer
...
>
	...
	<div class="absolute inset-0 rounded-xl bg-linear-to-br from-white/10 to-black/10"></div>
